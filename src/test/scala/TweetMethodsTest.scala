  ...
  "containsPictureURL" should {
   "return true if pic.twitter in list of URLs" >> {
    ...
    "return true if instagram  in list of URLs" >> {
      TweetMethods.containsPictureURL(Array("instagram.comfa","witter.comjflewqoio")) === true

    }
    "return true if both image URLs are in list of URLs" >> {
      TweetMethods.containsPictureURL(Array("pic.twitter.comjflewqoio","instagram.comjfld")) === true
